                                  ...
                                  onPressed: () {
                                    if (_emailEC.text.isNotEmpty) {
                                      context
                                          ...
                                          .forgotPassword(_emailEC.text.trim()); //adicionado trim() para remover os espacos após 
                                          // digitar o email ex: daviteste@gmai.com+ o + seria o espaço após o email, isso
